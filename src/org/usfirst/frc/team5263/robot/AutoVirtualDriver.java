...
public class AutoVirtualDriver {
	...
	//Object[] autosteps = { new drivestraight(-5, 0.7), new rotate(-90), new drivestraight(-5, 0.7), new rotate(-90), new drivestraight(-5, 0.7), new rotate(-90) ,new drivestraight(-5, 0.7), new rotate(-90) };//github.com/FRC5263/2017Robot.git
